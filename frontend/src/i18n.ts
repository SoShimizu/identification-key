...
export const STR = {
  ja: {
    ...
    candidatesPanel: {
        header_rank: "#",
        header_name: "名前",
        header_post_prob: "事後確率",
        header_score: "スコア",
        header_delta: "Δ",
        header_conflicts: "矛盾",
        header_match_support: "一致/適用",
        header_why: "なぜ？",
    ...
    justificationPanel: {
        title_prefix: "Justification for:",
        matches: "一致",
        conflicts: "矛盾",
        unobserved: "未観察",
        header_trait: "形質",
        header_your_choice: "あなたの選択",
        header_taxon_data: "タクソンのデータ",
        none: "なし",
        no_data: "データがありません。",
    },
    candidatesTab: {
  ...
  en: {
    ...
    candidatesPanel: {
        ...
        tooltip_why_prefix: "Why is it ranked here?:",
    ...
    justificationPanel: {
        ...
        header_trait: "Trait",
        header_your_choice: "Your Choice",
        header_taxon_data: "Taxon Data",
        none: "None",
